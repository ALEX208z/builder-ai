...
const PromptInput = ({
  onSubmit,
  loading = false,
  placeholder = "Describe the website you wnat to build...",
  large = false,
  autoFocus = false,
  variant = "default",
}) => {
  ...
  return (
    <div
      className={`bg-white border border-zinc-200 rounded-xl flex items-end gap-2 focus-within:right-1 in-focus-within:ring-zinc-300 transition ${large ? "p-4" : "p-3"}`}
    >
      <textarea
        ref={textareaRef}
        value={value}
