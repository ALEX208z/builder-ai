  ...
  return (
    <div className="hidden lg:flex lg:w-2/5 bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat flex-col justify-between p-12 shrink-0 select-none">
      ...
      <div>
        ...
        <p className="text-zinc-300">Describe what you need, preview instantly and customize your site in real-time.React with cleaner JSK, verified layouts, and instant code exports.  </p>
